...
StitchNodes --in "data/TEtextfiles/DetectNodes/NH/cyclone_DN_msl.txt" --out "data/TEtextfiles/StitchNodes/NH/cyclone_SN_msl.txt" --range 6.0 --min_endpoint_dist 8.0 --maxgap 4