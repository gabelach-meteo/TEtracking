...
DetectNodes --in_data "$input_msl" --timefilter "3hr" --out "anticyclone_DN_5.txt" --searchbymax 'msl' --closedcontourcmd "msl,-250.0,8.0,0" --mergedist 8.0 --thresholdcmd 'msl,>,101300,0.5' --outputcmd "msl,min,0" --regional --latname "latitude" --lonname "longitude" 

StitchNodes --in "anticyclone_DN_5.txt" --out "anticyclone_SN_5.txt" --range 6.0 --min_endpoint_dist 8.0 --maxgap 4